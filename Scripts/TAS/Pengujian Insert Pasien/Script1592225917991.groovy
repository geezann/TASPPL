...
WebUI.setText(findTestObject('Page_Sistem Antrian Disabilitas/input_Nama_name'), 'Brayen')

WebUI.setText(findTestObject('Page_Sistem Antrian Disabilitas/input_Nomor Rekam Medis_medical_record_number'), '080844444')

WebUI.setText(findTestObject('Page_Sistem Antrian Disabilitas/input_Nomor Telepon_phone_number'), '085637363')

'Stak disini pak, whyyyyyyyyyyy :('
WebUI.click(findTestObject('Page_Sistem Antrian Disabilitas/input_Tanggal Lahir_dob'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Page_Sistem Antrian Disabilitas/textarea_Alamat_address'), 'Jl. Kartini')
